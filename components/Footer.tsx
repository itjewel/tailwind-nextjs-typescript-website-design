...
<footer className="text-center lg:text-left bg-gray-100 text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
          Our mission is to make sure get access web hosting services to everyone! Who wants to  bring business or ideas to online . Get Started Today !
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <Link href="/about-us">
             <a className="text-gray-600 hover:text-blue-600">About us</a>
          </Link>
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          <Link href="/refund-policy">
             <a className="text-gray-600 hover:text-blue-600">Refund Policy</a>
          </Link>
        </p>
        <p className="mb-4">
           <Link href="/terms-condition">
             <a className="text-gray-600 hover:text-blue-600">Terms & Conditions</a>
          </Link>
        </p>
        <p>
          <Link href="/ticket-support">
             <a className="text-gray-600 hover:text-blue-600">Ticket Support</a>
          </Link>
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <Link href="/frequently">
             <a className="text-gray-600 hover:text-blue-600">Frequently</a>
          </Link>
        </p>
        <p className="mb-4">
           <Link href="/login">
      ...
      <div className="">
        ...
        <p className="flex items-center justify-center md:justify-start mb-4">
         ...
         2 Noyeau street Woodstock 2793
        </p>
        <p className="flex items-center justify-center md:justify-start mb-4">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <Link href="/">
        <a className="text-gray-600 hover:text-blue-600">Giant IT</a>
    </Link>
  </div>
</footer>
  );
